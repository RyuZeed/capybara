...
local urls = {
    "https://raw.githubusercontent.com/RyuZeed/capybara/main/modules/shared/modern_settings.lua?t=" .. tostring(os.time()),
    "https://raw.githubusercontent.com/RyuZeed/capybara/main/modules/shared/modern_settings.lua"
}
